    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_course', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='Schedule.course', verbose_name='Номер курса')),
                ('id_department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='Schedule.department', verbose_name='Кафедра')),
                ('id_educational_form', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='Schedule.educationalform', verbose_name='Форма обучения')),
                ('id_group', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='Schedule.group', verbose_name='Группа')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('id_group', models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, to='Schedule.group', verbose_name='Группа')),
                ('id_lessons_time', models.ForeignKey(default=1, on_delete=django.db.models.deletion.PROTECT, to='Schedule.lessontime', verbose_name='Номер пары')),
            ],
            options={
